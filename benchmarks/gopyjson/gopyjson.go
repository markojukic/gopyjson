...
func pTrim__7(b *[]byte, N *int, v *type5) {
	pTrimByte(b, N, '[')
	trimLeftSpace(b, N)
...
func pTrim__8(b *[]byte, N *int, v *type6) {
...
func pTrim__9(b *[]byte, N *int, v *type7) {
	var nonEmpty bool
	pTrimByte(b, N, '{')
	trimLeftSpace(b, N)
	for {
...
func pTrim__10(b *[]byte, N *int, v *type8) {
	var nonEmpty bool
	pTrimByte(b, N, '{')
	trimLeftSpace(b, N)
	for {
...
func pTrim__11(b *[]byte, N *int, v *type7) {
	var nonEmpty bool
	pTrimByte(b, N, '{')
	trimLeftSpace(b, N)
	for {
...
func pTrim__12(b *[]byte, N *int, v *type8) {
	var nonEmpty bool
	pTrimByte(b, N, '{')
	trimLeftSpace(b, N)
	for {
